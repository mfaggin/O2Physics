...
struct TimestampTask {
  ...
  void process(aod::BC const& bc)
  {
    ...
    if (verbose.value) {
      LOG(info) << "(verbose) bc.globalBC(): " << bc.globalBC();
      LOG(info) << "(verbose) o2::constants::lhc::LHCBunchSpacingNS: " << o2::constants::lhc::LHCBunchSpacingNS;
      LOG(info) << "(verbose) (orbitResetTimestamp + int64_t(bc.globalBC() * o2::constants::lhc::LHCBunchSpacingNS * 1e-3)) / 1000: " << (orbitResetTimestamp + int64_t(bc.globalBC() * o2::constants::lhc::LHCBunchSpacingNS * 1e-3)) / 1000;
    }
  }
};
